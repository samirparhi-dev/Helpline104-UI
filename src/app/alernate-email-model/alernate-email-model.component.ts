...
export class AlernateEmailModelComponent implements OnInit {
 ...
 // emailForm: FormGroup;
  ...
  constructor( @Inject(MD_DIALOG_DATA) public data: any, public dialog: MdDialog, public feedbackService: FeedbackService,
    public dialogReff: MdDialogRef<AlernateEmailModelComponent>, public fb: FormBuilder, public alertService: ConfirmationDialogsService,
