...
import { ConsentFormComponent } from "app/104-consent/consent-form.component";

@Component({
  selector: "app-104-co",
  templateUrl: "./104-co.component.html",
  styleUrls: ["./104-co.component.css"],
})
export class Co_104_Component implements OnInit, OnChanges, DoCheck {
  ...
  openConsent(){
   ...
   mdDialogRef.afterClosed().subscribe((consentProvided) => {
    ...
    if(consentProvided == true) {
      ...
      //   "closureScreen"
      //  ]);
      this.closeCallIfConsentNotProvided();
    }
    })
   }
