...
export class EditNotificationsComponent implements OnInit {
  ...
  constructor(@Inject(MD_DIALOG_DATA) public data: any,
   public dialogRef: MdDialogRef < EditNotificationsComponent > , private commonDataService: dataService, public httpServices: HttpServices
   ) {}
  ...
  onSubmit() {
    ...
    if (this.file && this.fileContent) {
      this.postData = {
        ...
        "notification": this.editNotificationForm.value.notificationSubject.trim(),
        "notificationDesc": this.editNotificationForm.value.notificationDesc.trim(),
        "validFrom": startDate,
        "validTill": endDate,
